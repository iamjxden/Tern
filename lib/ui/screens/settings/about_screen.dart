  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        _card('About', '''Tern by Aetheron is your AI workspace - chat, code and create with state of the art models, with your history always available wherever you sign in.

Your data never leaves your device. All inference happens locally using on-device compute.'''),
        const SizedBox(height: 16),
        _card('Privacy Policy', '''Tern does not collect, transmit, or store any personal data on external servers.
...
We do not use analytics, crash reporting, or any form of tracking.'''),
        const SizedBox(height: 16),
        _card('Terms of Service', '''By using Tern, you agree to the following:

1. Tern is provided as-is without warranty of any kind.
...
4. Aetheron is not liable for any outputs generated by AI models.
5. You agree not to use Tern to generate illegal, harmful, or malicious content.

Models downloaded through Tern are subject to their respective licenses (MIT, Apache 2.0, Llama Community License, etc.).'''),
        const SizedBox(height: 16),
        _card('Open Source', '''Tern is built on open source technology:
